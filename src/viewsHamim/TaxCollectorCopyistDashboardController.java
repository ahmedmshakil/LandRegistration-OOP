 ...
 * @author ASUS
 */
public class TaxCollectorCopyistDashboardController implements Initializable {
    ...
    @FXML
    private void taxCornerOnClick(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("TaxCorner.fxml"));
